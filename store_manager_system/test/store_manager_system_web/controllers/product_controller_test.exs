defmodule StoreManagerSystemWeb.ProductControllerTest do
  use StoreManagerSystemWeb.ConnCase

  import StoreManagerSystem.CompanyResourcesFixtures

  @create_attrs %{inventorycount: 42, name: "some name", retailPrice: 120.5, vendor: "some vendor", wholeSalePrice: 120.5}
