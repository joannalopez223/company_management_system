defmodule StoreManagerSystemWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StoreManagerSystemWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StoreManagerSystemWeb.Gettext, "errors", msg, opts)
    end
  end
