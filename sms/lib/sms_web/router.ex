defmodule SmsWeb.Router do
  ...
  scope "/", SmsWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{SmsWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", SmsWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{SmsWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", SmsWeb do
    ...
    live_session :current_user,
      on_mount: [{SmsWeb.UserAuth, :mount_current_user}] do
